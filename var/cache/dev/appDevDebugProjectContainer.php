...
class appDevDebugProjectContainer extends Container
{
    ...
    public function __construct()
    {
        ...
        $this->methodMap = array(
            ...
            'app_bundle.command' => 'getAppBundle_CommandService',
            'app_bundle.manager' => 'getAppBundle_ManagerService',
            'app_bundle.page_number' => 'getAppBundle_PageNumberService',
            ...
            'console.command.appbundle_command_loadfixtures' => 'getConsole_Command_AppbundleCommandLoadfixturesService',
            ...
            'vich_uploader.namer_uniqid.trick_image' => 'getVichUploader_NamerUniqid_TrickImageService',
    ...
    /**
     * Gets the public 'AppBundle\Form\Extension\ImageTypeExtension' shared autowired service.
     *
     * @return \AppBundle\Form\Extension\ImageTypeExtension
     */
    protected function getAppBundle_Form_Extension_ImageTypeExtensionService()
    {
        return $this->services['AppBundle\Form\Extension\ImageTypeExtension'] = new \AppBundle\Form\Extension\ImageTypeExtension();
    }
    ...
    /**
     * Gets the public 'app_bundle.command' shared service.
     *
     * @return \AppBundle\DataFixtures\ORM\LoadingTricks
     */
    protected function getAppBundle_CommandService()
    {
        return $this->services['app_bundle.command'] = new \AppBundle\DataFixtures\ORM\LoadingTricks(${($_ = isset($this->services['doctrine.orm.default_entity_manager']) ? $this->services['doctrine.orm.default_entity_manager'] : $this->get('doctrine.orm.default_entity_manager')) && false ?: '_'}, ${($_ = isset($this->services['fos_user.user_manager']) ? $this->services['fos_user.user_manager'] : $this->get('fos_user.user_manager')) && false ?: '_'});
    }

    /**
     * Gets the public 'app_bundle.manager' shared service.
     *
     * @return \AppBundle\Manager\Manager
     */
    protected function getAppBundle_ManagerService()
    {
        return $this->services['app_bundle.manager'] = new \AppBundle\Manager\Manager(${($_ = isset($this->services['doctrine.orm.default_entity_manager']) ? $this->services['doctrine.orm.default_entity_manager'] : $this->get('doctrine.orm.default_entity_manager')) && false ?: '_'});
    }

    /**
     * Gets the public 'app_bundle.page_number' shared service.
     *
     * @return \AppBundle\PageNumber\PageNumber
     */
    protected function getAppBundle_PageNumberService()
    {
        return $this->services['app_bundle.page_number'] = new \AppBundle\PageNumber\PageNumber(10);
    }
    ...
    protected function getConfigCacheFactoryService()
    {
        return $this->services['config_cache_factory'] = new \Symfony\Component\Config\ResourceCheckerConfigCacheFactory(new RewindableGenerator(function () {
            yield 0 => ${($_ = isset($this->services['1_ce621ee2514624a6996723b0bde1039ebfbb59b8901a8e7a95b6266c69c00368']) ? $this->services['1_ce621ee2514624a6996723b0bde1039ebfbb59b8901a8e7a95b6266c69c00368'] : $this->get1Ce621ee2514624a6996723b0bde1039ebfbb59b8901a8e7a95b6266c69c00368Service()) && false ?: '_'};
            yield 1 => ${($_ = isset($this->services['2_ce621ee2514624a6996723b0bde1039ebfbb59b8901a8e7a95b6266c69c00368']) ? $this->services['2_ce621ee2514624a6996723b0bde1039ebfbb59b8901a8e7a95b6266c69c00368'] : $this->get2Ce621ee2514624a6996723b0bde1039ebfbb59b8901a8e7a95b6266c69c00368Service()) && false ?: '_'};
        }, 2));
    }

    /**
     * Gets the public 'console.command.appbundle_command_loadfixtures' shared autowired service.
     *
     * @return \AppBundle\Command\LoadFixtures
     */
    protected function getConsole_Command_AppbundleCommandLoadfixturesService()
    {
        return $this->services['console.command.appbundle_command_loadfixtures'] = new \AppBundle\Command\LoadFixtures();
    }
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        $f->setAnnotationReader(${($_ = isset($this->services['annotation_reader']) ? $this->services['annotation_reader'] : $this->get('annotation_reader')) && false ?: '_'});

        $g = new \Symfony\Bridge\Doctrine\ContainerAwareEventManager($this);
        $g->addEventSubscriber(new \Vich\UploaderBundle\EventListener\Doctrine\CleanListener('trick_image', $e, $a, $b));
        ...
        $g->addEventSubscriber(new \Vich\UploaderBundle\EventListener\Doctrine\RemoveListener('trick_image', $e, $a, $b));
        $g->addEventSubscriber(new \Vich\UploaderBundle\EventListener\Doctrine\UploadListener('trick_image', $e, $a, $b));
        ...
        return $this->services['doctrine.dbal.default_connection'] = ${($_ = isset($this->services['doctrine.dbal.connection_factory']) ? $this->services['doctrine.dbal.connection_factory'] : $this->get('doctrine.dbal.connection_factory')) && false ?: '_'}->createConnection(array('driver' => 'pdo_mysql', 'host' => 'localhost', 'port' => 8889, 'dbname' => 'snowtricks', 'user' => 'root', 'password' => 'root', 'unix_socket' => ($this->targetDirs[5].'/tmp/mysql/mysql.sock'), 'charset' => 'UTF8', 'driverOptions' => array(), 'serverVersion' => 5.5999999999999996, 'defaultTableOptions' => array()), $d, $g, array());
    }
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf2orm_default_939083109be78b943451ee4e13b9b61d5ae26a7229a6dd3004da559d175dace0');
    ...
    {
        return $this->services['twig.form.renderer'] = new \Symfony\Bridge\Twig\Form\TwigRenderer(new \Symfony\Bridge\Twig\Form\TwigRendererEngine(array(0 => 'fields.html.twig', 1 => 'form_div_layout.html.twig', 2 => 'materializeLayout.html.twig'), ${($_ = isset($this->services['twig']) ? $this->services['twig'] : $this->get('twig')) && false ?: '_'}), ${($_ = isset($this->services['security.csrf.token_manager']) ? $this->services['security.csrf.token_manager'] : $this->get('security.csrf.token_manager', ContainerInterface::NULL_ON_INVALID_REFERENCE)) && false ?: '_'});
    }
    ...
    {
        return $this->services['uri_signer'] = new \Symfony\Component\HttpKernel\UriSigner('b2069ff56c34d31d15f955649bde3a39fa85d858');
    }
    ...
    /**
     * Gets the public 'vich_uploader.namer_uniqid.trick_image' shared service.
     *
     * @return \Vich\UploaderBundle\Naming\UniqidNamer
     */
    protected function getVichUploader_NamerUniqid_TrickImageService()
    {
        return $this->services['vich_uploader.namer_uniqid.trick_image'] = new \Vich\UploaderBundle\Naming\UniqidNamer();
    }
    ...
    /**
     * Gets the private '1_ce621ee2514624a6996723b0bde1039ebfbb59b8901a8e7a95b6266c69c00368' shared service.
     *
     * @return \Symfony\Component\DependencyInjection\Config\ContainerParametersResourceChecker
     */
    protected function get1Ce621ee2514624a6996723b0bde1039ebfbb59b8901a8e7a95b6266c69c00368Service()
    {
        return $this->services['1_ce621ee2514624a6996723b0bde1039ebfbb59b8901a8e7a95b6266c69c00368'] = new \Symfony\Component\DependencyInjection\Config\ContainerParametersResourceChecker($this);
    }

    /**
     * Gets the private '2_ce621ee2514624a6996723b0bde1039ebfbb59b8901a8e7a95b6266c69c00368' shared service.
     *
     * @return \Symfony\Component\Config\Resource\SelfCheckingResourceChecker
     */
    protected function get2Ce621ee2514624a6996723b0bde1039ebfbb59b8901a8e7a95b6266c69c00368Service()
    {
        return $this->services['2_ce621ee2514624a6996723b0bde1039ebfbb59b8901a8e7a95b6266c69c00368'] = new \Symfony\Component\Config\Resource\SelfCheckingResourceChecker();
    }
    ...
    {
        $this->services['cache.app.recorder_inner'] = $instance = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('Yw39mQTzLV', 0, (__DIR__.'/pools'));
    ...
    {
        return $this->services['cache.serializer.recorder_inner'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('ozvyOBDjpg', 0, 'rYGsf+g6KTBMZScRLpNz0L', (__DIR__.'/pools'), ${($_ = isset($this->services['monolog.logger.cache']) ? $this->services['monolog.logger.cache'] : $this->get('monolog.logger.cache', ContainerInterface::NULL_ON_INVALID_REFERENCE)) && false ?: '_'});
    }
    ...
    {
        return $this->services['cache.system.recorder_inner'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('dp0Nx5LN13', 0, 'rYGsf+g6KTBMZScRLpNz0L', (__DIR__.'/pools'), ${($_ = isset($this->services['monolog.logger.cache']) ? $this->services['monolog.logger.cache'] : $this->get('monolog.logger.cache', ContainerInterface::NULL_ON_INVALID_REFERENCE)) && false ?: '_'});
    }
    ...
    {
        return $this->services['cache.validator.recorder_inner'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('CkjvIFwZeo', 0, 'rYGsf+g6KTBMZScRLpNz0L', (__DIR__.'/pools'), ${($_ = isset($this->services['monolog.logger.cache']) ? $this->services['monolog.logger.cache'] : $this->get('monolog.logger.cache', ContainerInterface::NULL_ON_INVALID_REFERENCE)) && false ?: '_'});
    }
    ...
    {
        return $this->services['security.authentication.provider.anonymous.main'] = new \Symfony\Component\Security\Core\Authentication\Provider\AnonymousAuthenticationProvider('59c530f94c7ed5.21189652');
    }
        ...
        switch ($name) {
            ...
            case 'vich_uploader.mappings': $value = array(
                'trick_image' => array(
                    ...
                    'upload_destination' => ($this->targetDirs[3].'/app/../web/uploads/img'),
                    'namer' => array(
                        'service' => 'vich_uploader.namer_uniqid.trick_image',
                        'options' => array(
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'secret' => 'b2069ff56c34d31d15f955649bde3a39fa85d858',
            'locale' => 'en',
            'fragment.renderer.hinclude.global_template' => NULL,
            'fragment.path' => '/_fragment',
            'kernel.secret' => 'b2069ff56c34d31d15f955649bde3a39fa85d858',
            ...
            'console.command.ids' => array(
                'console.command.appbundle_command_loadfixtures' => 'console.command.appbundle_command_loadfixtures',
